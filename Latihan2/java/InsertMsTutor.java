...
public class InsertMsTutor{
    public static void main(String[] args) {
        String id, nama,alamat,email,gender,date,hp;
        String alamatFile = "/home/anangmb/Kuliah/Semester2/prakWeb/4/Latihan2/sql/insertMsTutor.sql";
        try{
        ...
        while(true){
                ...
                date = br.readLine();
                String fileContent = "insert into ms_tutor values('"+ id +"','" + nama + "','" + alamat + "','" + hp +"','" + email +"','" + gender +"','"+ date +"');\n";
